 ...
 *
 */
public class PiecewiseAlgorithm {
	...
	// Sub-area list 
	private List<SubAreaProcessor.SubArea> subareaList;
	 ...
	 */
	public PiecewiseAlgorithm(AclfNetwork net) {
		this.net = net;
	 ...
	 * @param net AclfNetwork object
	 */
	public PiecewiseAlgorithm(AclfNetwork net, List<SubAreaProcessor.SubArea> subareaList) {
		this(net);
	...
	private void solveSubAreaNet(int areaFlag, Function<AclfBus,Complex> injCurrentFunc) throws IpssNumericException {
		...
		SubAreaProcessor.SubArea subArea = this.getSubArea(areaFlag);
	 ...
	 * @throws IpssNumericException
	 */
	public void calcuateNetVoltage(SubAreaProcessor.CuttingBranch[] cuttingBranches)  throws IpssNumericException {
		for(SubAreaProcessor.SubArea subarea : this.subareaList)
	 ...
	 * @throws IpssNumericException
	 */
	private void calcuateSubAreaVoltage(SubAreaProcessor.SubArea subArea, SubAreaProcessor.CuttingBranch[] cuttingBranches)  throws IpssNumericException {
	 ...
	 */
	public void calculateCuttingBranchCurrent(SubAreaProcessor.CuttingBranch[] cuttingBranches) throws IpssNumericException { 
	 ...
	 */
	private Complex[] cuttingBranchOpenCircuitVoltage(SubAreaProcessor.CuttingBranch[] cuttingBranches) {
	 ...
	 * @return the z-matrix
	 */
	private Complex[][] buildEquivZMtrix(SubAreaProcessor.CuttingBranch[] cuttingBranches)  throws IpssNumericException {
		int nCutBranches = cuttingBranches.length;
	 ...
	 * @throws IpssNumericException
	 */
	private void formSubAreaZMatrix(SubAreaProcessor.SubArea subarea) throws IpssNumericException {
